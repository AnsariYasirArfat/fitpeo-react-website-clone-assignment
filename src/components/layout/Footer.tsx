...
const Footer = () => {
  ...
  return (
    <footer className="px-4 md:px-6 py-[5rem] border-t-[--rounded-main] border-fitpeo-red bg-fitpeo-red  !text-fitpeo-black [--focus-color:theme(colors.fitpeo.white)] lg:sticky bottom-0 z-0">
